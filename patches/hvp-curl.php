 ...
 *
 * Test-environment overlay: the upstream put() signature drifted from core
 * (core added $includeuserpwd in Moodle 5.x). This overlay file is bind-mounted
 * over the submodule's classes/curl.php in docker-compose.yml so the submodule
